...
class restaurante:
    ...
    #     codigo = (input("Digite codigo del plato: \n"))
    #     if (codigo.isdigit()):
    #         return int(codigo)
    #     else:
    #         print("El codigo solo puede ser numeros!!")
    #         self.validarCodigo()
...
# restaurante.guardar(1, "Picante", 15, "picante de pollo", "almuerzo", 12)
# restaurante.guardar(2, "Volcan de Chocolate", 12, "Volcan de cholate negro", "postre", 10)
# restaurante.guardar(3, "Salteña", 8, "Salteña de pollo picante", "desayuno", 8)
# restaurante.guardar(4, "Locro", 7, "Locro de gallina criolla", "cena", 5)
restaurante.menu()
